...
class DBHandler:
    ...
    All lookups use get-or-create pattern to maintain normalization.
    """
    ...
    def __init__(self, db_path):
        ...
        # executescript must run first — creates all tables
    ...
    def get_pending_keywords(self) -> list[str]:
        """Return all keywords not yet processed, in alphabetical order"""
